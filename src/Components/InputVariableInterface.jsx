...
const InputVariableInterface = () => {
    ...
    return(
        <div className='w-1/4 h-1/2 flex flex-col items-start justify-start border-2 border-black rounded-lg p-5'>
            <h3 className='self-center mb-5 pt-2 text-lg font-semibold'>Predictive Inputs</h3>
            ...
            <button className='self-center rounded-xl bg-green-200 p-2.5' onClick={handleSubmitData}>Predict Output
            </button>
        </div>
    )
}
export default InputVariableInterface;